...
- My Team rows are 50px high, with 12px spacing between tables. Tables retain
  ...
  price, inline charts, Tags, and Notes as their matching position page. Watch
  ratings are managed from the selected player's companion page and are not
  displayed in My Team tables. Both price
