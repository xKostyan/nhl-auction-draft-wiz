...
- My Team rows are 50px high, with 12px spacing between tables. Tables retain
  ...
  available cell width. Average Performance uses light green and green bands
  at 3.7 to below 4.1 and 4.1+ for skaters, and 7.9 to below 8.3 and 8.3+ for
  goalies. Utility has the
